...
if __name__ == '__main__':
	...
	baltic = Boat("Baltic", model=0, max_students=5, max_teachers=2, capacity_students=3, capacity_teachers=1,
				  min_teachers=1)
	north = Boat("North", model=1, max_students=5, max_teachers=2, capacity_students=2, capacity_teachers=1,
				 min_teachers=1)
